            ...
            try
            {
                using (var session = _driver.AsyncSession())
                {
                    ...
                    var insertQuery = $@"INSERT INTO Obavestenje (naslov, sadrzaj, datumObjave, status, skijaliste_naziv, lokacija) 
                                            VALUES 
                                        ('{obavestenje.Naslov}', '{obavestenje.Sadrzaj}', '{obavestenje.DatumObjave}', '{obavestenje.Satus}', '{obavestenje.Skijaliste.Naziv}', '{obavestenje.Skijaliste.Lokacija}')";
